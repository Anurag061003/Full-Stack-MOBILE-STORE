...
const CheckOutSingle = () => {
 ...
 useEffect(() => {
    ...
    let mobile1 = JSON.parse(localStorage.getItem('mobile'))
    setMobile(mobile1)
    setFirstName(name)
    setEmail(customerEmail)
   /* totalCost = 0;
    totalCost = products[book].DiscountDetails.length > 0 ? products[book].DiscountDetails[book].finalPrice : products[book].originalPrice;
  ...
  async function goToBuy() {
    ...
    if (token) {
      ...
      const stripe = await loadStripe('pk_test_51SPd2u0Ritb203vFIkiw26uD7bkXPDv5vlFV6GkR4gheVLUkNT44Q9MBcNthQYtertDTVH5cDAD80oU379D3c1kE00jUcpsRcD')
            ...
            <table className='table'>
              ...
              <tbody>
                <tr>
                  ...
                  { <td>
                    { mobile && mobile.DiscountDetails.length > 0
                      ? mobile.DiscountDetails[0].finalPrice
                      : mobile.price}
                  </td> }
